...
comorbid_covid_exp_with= function(var){
  ...
  plot = ggplot(var_data, aes(x = reorder(diagnosis,-proportion), y = proportion)) + 
    geom_bar(stat="identity") + 
    labs(title = paste("Proportion of Respondents Who Experienced Each Situation Who Also Experienced '", var, "'"), x = "Stress Experience") +
    theme(axis.text.x = element_text(angle = 45, hjust=1)) 
...
comorbid_diagnosis_with= function(var){
  ...
  ggplot(var_data, aes(x = diagnosis, y = proportion)) + 
    geom_bar(stat="identity") + 
