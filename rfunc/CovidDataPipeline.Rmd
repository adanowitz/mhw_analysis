...
load.raw <- function(path){
    ...
    data_cleaned<-subset(data,consent=="Yes, I volunteer, am 18 or older, and am enrolled in an undergraduate engineering program")#& ((year_in_program == "1") | (year_in_program == "2") | (year_in_program=="Prefer not to respond")) & kessler1!="")
    return(data_cleaned)
}
...
data = load.raw("undergrad_engineering_mh_COVID19_updated2.csv")
```
